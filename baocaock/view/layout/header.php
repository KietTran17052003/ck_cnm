                                ...
                                <div class="container flex justify-between">
                                    ...
                                    <div class="navbar magic-shadow">
                                        <div class="container flex justify-center">
                                            ...
                                            <a href="index.php?page=home#gioithieu">GIỚI THIỆU</a>
                                            <a href="index.php?page=home#thucdon">THỰC ĐƠN</a>
                                            <a href="index.php?page=home#datban">ĐẶT BÀN</a>                                 
                                            <a href="index.php?page=hoso"><i class="fas fa-user-alt"></i></a>';
